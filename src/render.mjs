          ...
          <div class="console-grid">
            ...
            <main id="main" class="console-content" tabindex="-1">
              ...
              <section id="work" class="terminal-section terminal-view" aria-labelledby="work-title">
                ...
                <aside class="concept-invite" data-boot><div><span>NEW / INTERACTIVE CONCEPTS</span><h3>Hospitality. Events. Retail. Home service.</h3><p>Step inside four fictional businesses and try the customer experience for yourself.</p></div><a class="terminal-button" href="#concepts">Enter concept lab</a></aside>
              </section>
